                  ...
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    ...
                    <div className="bg-white border-2 border-primary-400 rounded-lg p-4 mt-4">
                      ...
                      <p className="text-gray-700 text-sm mt-2 leading-relaxed">
                        ...
                        sur notre site internet. Vos informations sont
                        uniquement conservées dans nos boîtes emails
                        professionnelles pour le traitement de votre demande.
                      </p>
                    </div>
                    <p>
            ...
            <div className="bg-gray-50 rounded-xl p-8 border border-gray-200">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p>
                  ...
                  cookies ou être averti lors de leur dépôt. Notez que le refus
                  de certains cookies peut limiter les fonctionnalités du site.
                </p>
              </div>
            </div>
