...
export default function OffersSection() {
  return (
    <>
      <div id="offres" className="mb-6"></div>
        ...
        <div className="flex justify-center">
          <div className="customContainer">
            ...
            <div className="space-y-8 ">
              {/* Offre de Lancement */}
              <div className="bg-white  rounded-xl shadow-sm border border-secondary  overflow-hidden hover:shadow-md transition-shadow duration-300">
                <div className="p-8">
              ...
              {/* Offre Parrainage */}
              <div className="bg-white rounded-xl shadow-sm border-2 border-primary overflow-hidden hover:shadow-md transition-shadow duration-300">
